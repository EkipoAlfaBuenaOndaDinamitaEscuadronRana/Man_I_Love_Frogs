...
class TestYacc(unittest.TestCase):
    def test_yacc(self):
        ...
        test_answers = [
            ...
            "01 | GOTO - - 2\n02 | EQ 1 - a\n03 | WRITE - - a\n04 | ENDOF - - -\n",
            "01 | ADD 1 2 T1\n02 | EQ T1 - a\n03 | GOTO - - 4\n04 | WRITE - - a\n05 | ENDOF - - -\n",
            '01 | GOTO - - 32\n02 | MUL j 2 T1\n03 | SUB p T1 T2\n04 | ADD T2 j T3\n05 | ADD j T3 T4\n06 | EQ T4 - i\n07 | BEQ j 1 T5\n08 | GOTOF T5 - 12\n09 | RETURN j - -\n10 | GOTO - - 19\n11 | GOTO - - 20\n12 | ERA fact - -\n13 | SUB j 1 T6\n14 | PARAM T6 - param1\n15 | GOSUB fact - 2\n16 | EQ fact - T7\n17 | MUL j T7 T8\n18 | RETURN T8 - -\n19 | ENDFUNC - - -\n20 | EQ 0 - x\n21 | LT x 11 T1\n22 | GOTOF T1 - 31\n23 | GOTO - - 24\n24 | VER x 0 9\n25 | ADD x 0 T2\n26 | ADD T2 Arreglo-BA (T3)\n27 | MUL y x T4\n28 | EQ T4 - (T3)\n29 | ADDEQ 1 - x\n30 | GOTO - - 21\n31 | ENDFUNC - - -\n32 | EQ READ - p\n33 | MUL p 2 T1\n34 | EQ T1 - j\n35 | ERA inicia - -\n36 | MUL p j T2\n37 | SUB T2 5 T3\n38 | PARAM T3 - param1\n39 | GOSUB inicia - 20\n40 | EQ 0 - i\n41 | LT i 9 T4\n42 | GOTOF T4 - 62\n43 | GOTO - - 45\n44 | ADDEQ 1 - i\n45 | VER p 0 9\n46 | ADD p 0 T5\n47 | ADD T5 Arreglo-BA (T6)\n48 | VER i 0 9\n49 | ADD i 0 T7\n50 | ADD T7 Arreglo-BA (T8)\n51 | ERA fact - -\n52 | VER i 0 9\n53 | ADD i 0 T9\n54 | ADD T9 Arreglo-BA (T10)\n55 | SUB (T10) p T11\n56 | PARAM T11 - param1\n57 | GOSUB fact - 2\n58 | EQ fact - T12\n59 | MUL (T8) T12 T13\n60 | EQ T13 - (T6)\n61 | GOTO - - 41\n62 | EQ 0 - j\n63 | LT j 2 T14\n64 | GOTOF T14 - 94\n65 | GOTO - - 67\n66 | ADDEQ 1 - j\n67 | EQ 0 - k\n68 | LT k 7 T15\n69 | GOTOF T15 - 93\n70 | GOTO - - 72\n71 | ADDEQ 1 - k\n72 | VER j 0 2\n73 | MUL j 8 T16\n74 | VER k 0 7\n75 | ADD T16 k T17\n76 | ADD T17 0 T18\n77 | ADD T18 Matriz-BA (T19)\n78 | ERA fact - -\n79 | PARAM p - param1\n80 | GOSUB fact - 2\n81 | EQ fact - T20\n82 | ADD j k T21\n83 | SUB T21 T20 T22\n84 | MUL p k T23\n85 | ADD T22 T23 T24\n86 | VER T24 0 9\n87 | ADD T24 0 T25\n88 | ADD T25 Arreglo-BA (T26)\n89 | MUL (T26) p T27\n90 | ADD T27 j T28\n91 | EQ T28 - (T19)\n92 | GOTO - - 68\n93 | GOTO - - 63\n94 | GTE i 0 T29\n95 | GOTOF T29 - 111\n96 | GOTO - - 97\n97 | WRITE - - "Resultado"\n98 | VER i 0 9\n99 | ADD i 0 T30\n100 | ADD T30 Arreglo-BA (T31)\n101 | WRITE - - (T31)\n102 | ERA fact - -\n103 | ADD i 2 T32\n104 | PARAM T32 - param1\n105 | GOSUB fact - 2\n106 | EQ fact - T33\n107 | MUL T33 valor T34\n108 | WRITE - - T34\n109 | SUBEQ 1 - i\n110 | GOTO - - 94\n111 | ENDOF - - -\n',
        ]
